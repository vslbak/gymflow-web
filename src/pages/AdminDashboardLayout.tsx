...
export default function AdminDashboardLayout() {
  ...
  useEffect(() => {
    ...
    if (path === '/classes/manage' || path === '/classes/manage/overview') {
      setActiveTab('overview');
    } else if (path === '/classes/manage/classes') {
  ...
  const tabs = [
    { id: 'overview', label: 'Overview', icon: BarChart3, path: '/classes/manage' },
    { id: 'classes', label: 'Classes', icon: Dumbbell, path: '/classes/manage/classes' },
  ];
